...
public class Othello {
    ...
    public int endOfGame() 
    {
        ...
        {
            if(userCont == -1 && computerCont == -1) //No empty cells
                return 0;
            if(circular > cross)
                return 1;
	...
	int status = -1, corX, corY, temp;
        ...
        x = xCor; y = yCor;
	numberOfMoves[0] = 0;
	if((x+1 < rows) && ( gameCells[x+1][y].getCh() == char2)) //down
	{	
            cont = x;
	...
	if((x-1 >= 0) && (gameCells[x-1][y].getCh() == char2)) //up
	{
            cont = x;
	...
	if((y+1 < cols) && (gameCells[x][y+1].getCh() == char2)) //right
	{
	...
	if((y-1 >= 0) && (gameCells[x][y-1].getCh() == char2)) //left
	{
            cont = y;
            while((cont >= 0) && (st2 != -1) && (st != 2))
            {
	...
	if((x-1 >= 0) && (y+1 < cols) && (gameCells[x-1][y+1].getCh() == char2)) //right+up
	{
            corY = y;
            corX = x;
	...
	if((x-1 >= 0) && (y-1 >= 0) && (gameCells[x-1][y-1].getCh() == char2)) //left+up
	{
            corY = y;
            corX = x;
	...
	if((x+1 < rows) && (y+1 < cols) && (gameCells[x+1][y+1].getCh() == char2)) //right+down
	{
            corY = y;
            corX = x;
	...
	if((x+1 < rows) && (y-1 >= 0) && (gameCells[x+1][y-1].getCh() == char2)) //left+down
	{
            corY = y;
            corX = x;
